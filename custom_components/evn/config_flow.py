...
class EVNConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        schema = vol.Schema({
            vol.Required(CONF_FORWARD_TOTAL): _entity_sel(),  # sensor tổng mua (kWh, total_increasing)
            vol.Required(CONF_REVERSE_TOTAL): _entity_sel(),  # sensor tổng bán (kWh, total_increasing)
